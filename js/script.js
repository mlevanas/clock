...
function setClock12(hr, min, sec)
{
	...
	document.querySelector('#am-pm').value = (hr >= 12) ? 'PM' : 'AM';
}
...
function change_color(el, color_code) {
	...
	let hours_input = document.querySelectorAll('.hours');
	hours_input.forEach((hi) => {
		hi.style.borderTop = 'solid 15px ' + color_code;
		hi.style.borderLeft = 'solid 15px ' + color_code;
		hi.style.borderBottom = 'solid 15px ' + color_code;
	});

	let minutes_input = document.querySelectorAll('.minutes');
	minutes_input.forEach(mi => {
		mi.style.borderTop = 'solid 15px ' + color_code;
		mi.style.borderBottom = 'solid 15px ' + color_code;
		mi.style.borderRight = 'solid 15px ' + color_code;
	});

	let second_input = document.querySelectorAll('.seconds');
	second_input.forEach(si => {
		si.style.borderTop = 'solid 15px ' + color_code;
		si.style.borderLeft = 'solid 15px ' + color_code;
		si.style.borderRight = 'solid 15px ' + color_code;
		si.style.borderBottom = 'solid 15px ' + color_code;
	});
